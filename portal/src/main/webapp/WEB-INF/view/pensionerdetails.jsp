...
<div class="pension-form">
  	...
  	<h2 class="error" style="color:red"> ${invaliddetails}</h2> 
  	<label for="name">Pensioner's Name</label>
    <form:input path="name" type="text" placeholder="Enter Pensioner's Name" required="required" style="color:grey;"/>

    <label for="dateOfBirth">Date Of Birth</label>
    <form:input  path="dateOfBirth" type="date" placeholder="Enter your D.O.B" required="required" style="color:grey;"/>
 
 
 	<label for="pan">PAN Number</label>
    <form:input  path="pan" type="text"  placeholder="Enter your PanCard Number"  pattern="[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}" title="Please enter valid PAN number. E.g. AAAAA9999A" style="color:grey;" required="required"/>

    <label for="aadhar">Aadhaar Number</label>
    <form:input  path="aadharNumber" type="text" placeholder="Enter AadharCard Number" pattern="^[2-9]{1}[0-9]{11}$"  length="12"  required="required" style="color:grey;"/><br>
